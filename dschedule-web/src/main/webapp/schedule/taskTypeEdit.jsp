...
<tr>
	...
	<td>处理模式：</td><td><input type="text" name="processType" value="<%=taskType.getKind()%>" width="30">
		Sleep  Normal   Group</td>
</tr>
<tr>
...
<tr>
	<td>组内项名称：</td><td><input type="text" name="groupItemName" value="<%=taskType.getGroupItemName()==null?"":taskType.getGroupItemName()%>" width="30"></td>
	<td>组内执行顺序：</td><td><input type="text" name="groupIndex" value="<%=taskType.getGroupIndex()%>" width="30"></td>
</tr>
<tr>
