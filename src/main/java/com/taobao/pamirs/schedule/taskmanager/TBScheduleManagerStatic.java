...
public class TBScheduleManagerStatic extends TBScheduleManager {
	...
	public TBScheduleManagerStatic(TBScheduleFactory aFactory,
			String baseTaskType, String ownSign,IScheduleDataManager scheduleDataManager) throws Exception {
...
//				获取执行的bean
		Object dealBean = this.factory.getBean(this.taskTypeInfo.getDealBeanName());
		if (dealBean == null) {
//			throw new Exception( "SpringBean " + this.taskTypeInfo.getDealBeanName() + " 不存在");
			dealBean = Class.forName(this.taskTypeInfo.getDealBeanName()).newInstance();
		}
