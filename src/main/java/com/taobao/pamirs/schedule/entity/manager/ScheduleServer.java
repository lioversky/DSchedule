...
public class ScheduleServer {
	...
	public static ScheduleServer createScheduleServer(long sysTime, String aBaseTaskType, String aOwnSign, int aThreadNum) throws Exception {
		...
		result.registerTime = new Timestamp(sysTime);
		...
		String s = DATA_FORMAT_yyyyMMdd.format(new Date(sysTime));
