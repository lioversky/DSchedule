<%@page import="com.taobao.pamirs.schedule.entity.strategy.ManagerFactoryInfo"%>
<%@page import="com.taobao.pamirs.schedule.entity.strategy.ScheduleStrategy"%>
...
<%
List<ManagerFactoryInfo> list =  ConsoleManager.getScheduleFactoryManager().loadAllManagerFactoryInfo();
String sts ="";
String action;
String actionName;
