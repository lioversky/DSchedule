...
public class ScheduleStrategyDataManager4ZK{
	 ...
	 * @throws Exception
	 */
	public List<String> reloadStrategyFactory(ManagerFactoryInfo managerFactory) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void unRregisterStrategyFactory(ManagerFactoryInfo managerFactory) throws Exception{
